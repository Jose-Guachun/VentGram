    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_area', models.CharField(blank=True, max_length=100, validators=[django.core.validators.MinLengthValidator(4)])),
                ...
                ('favorites', models.ManyToManyField(blank=True, related_name='favorites', to='posts.Project')),
